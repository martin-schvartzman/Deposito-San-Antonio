...
<?php if(isset($_POST["nombre"])){ newservicio($_POST["n"],$_POST["k"],$_POST["d"],$_POST["i"]);?>
<style>
...
<center>
	<div id="main">
		<div>
			...
			<div id="cont">
			El servicio fue ingresado exitosamente.
			</div>
		</div>
	</div>
</center>
...
<?php }else{ ?>
<form action="http://admin.depositosanantonio.com.ar/modulos/admin/abm/newser.php" method="post">
<table>
<tr>
	<td>Nombre:</td>
...
Info:<br/>
<textarea rows="20" cols="50" name="i"></textarea><br/>
