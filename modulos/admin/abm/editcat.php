...
<?php if(isset($_POST["nombre"])){ editcategoria($_POST["n"],$_POST["k"],$_POST["d"],$_POST["id"]); ?>
<style>
...
<?php }else{ $s=getinfocategoria($_GET["id"]);?>
<form action="http://admin.depositosanantonio.com.ar/modulos/admin/abm/editcat.php" method="post">
<table>
<tr>
	<td>Nombre:</td>
...
<tr>
	<td>Keywords:</td>
	<td><input type="text" name="k" value="<?php echo $s["keywords"]; ?>" /></td>
</tr>
</table>
Descripcion:<br/>
