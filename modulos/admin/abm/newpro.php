...
<?php if(isset($_POST["nombre"])){ newproducto($_POST["n"],$_POST["k"],$_POST["d"],$_POST["f"],$_POST["c"]);?>
<style>
...
<center>
	<div id="main">
		<div>
			...
			<div id="cont">
			El producto fue ingresado exitosamente.
			</div>
		</div>
	</div>
</center>
...
<?php }else{ ?>
<form action="http://admin.depositosanantonio.com.ar/modulos/admin/abm/newpro.php" method="post">
<table>
<tr>
	<td>Nombre:</td>
...
<input type="hidden" name="c" value="<?php echo $_GET["id"]; ?>" />
Descripcion:<br/>
