...
<?php if(isset($_POST["nombre"])){ editproducto($_POST["n"],$_POST["k"],$_POST["d"],$_POST["f"],$_POST["id"]); ?>
<style>
...
<?php }else{ $s=getproducto($_GET["id"]);?>
<form action="http://admin.depositosanantonio.com.ar/modulos/admin/abm/editpro.php" method="post">
<table>
<tr>
	<td>Nombre:</td>
	<td><input type="text" name="n" value="<?php echo $s["nombre"]; ?>" style="width:200px;" /></td>
</tr>
<tr>
	<td>Keywords:</td>
	<td><input type="text" name="k" value="<?php echo $s["keywords"]; ?>" style="width:200px;" /></td>
</tr>
<tr>
	<td>Foto:</td>
	<td><input type="text" name="f" value="<?php echo $s["foto"]; ?>" style="width:200px;" /></td>
</tr>
</table>
Descripcion:<br/>
